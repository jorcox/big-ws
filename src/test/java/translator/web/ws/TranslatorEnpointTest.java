...
public class TranslatorEnpointTest {
	...
	public void testSendAndReceive() {
		...
		request.setText("Live mother Russia and long live the Bolshevik revolution. Stalin was a murderer.");
		...
		assertThat(((GetTranslationResponse) response).getTranslation(), is("Viva la madre Rusia y larga vida a la revolución Bolchevique. Stalin era un asesino."));
	}	
}
